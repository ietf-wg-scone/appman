...
- Subscriber Policies and Data Plans: The throughput advice may be based on
the user's subscription. However, even in those cases the rate limit might
not be static but could be updated e.g. when a
